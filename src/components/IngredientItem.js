...
function toggleIngredient(ingredient, pizzaId, pizzaToCustomize){
  ...
  const updatedPizza = { ...pizzaCustomWithIngredient };
  updatedPizza.ingredient = [...pizzaCustomWithIngredient.ingredient];
  updatedPizza.sizeSelectedPrice = pizzaCustomWithIngredient.sizeSelectedPrice;
  pizzaCustomWithIngredient = updatedPizza;
  ...
  return (
    ...
    <Col className='ingredients'>
      <Card style={{ width: '10rem' }} onClick={() => toggleIngredient(ingredient, pizzaId, pizzaToCustomize)}>
      <Card.Title>{ingredient.title}</Card.Title>
        <Card.Img variant="top" src={ingredient.imageReact} alt={ingredient.title} />
        <Card.Body>
            <Card.Text>
            ...
            Add
                ...
                <div>
      {displayIngTop && <img src={ingredient.imageCustomReact} alt={ingredient.title} />}
    </div>
        </Card.Body>
      </Card>
    </Col>
